...
export default function App() {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#f8fafc", color:"#0f172a", fontFamily:"'Plus Jakarta Sans', system-ui, sans-serif" }}>
      <style>{`
          ...
          {view === "table" && (
            <div style={{ overflowX:"auto", padding:"20px 32px 32px" }}>
              <table style={{ width:"100%", borderCollapse:"collapse", fontSize:"13px", tableLayout:"fixed" }}>
                <colgroup>
                  <col style={{ width:"140px" }} /><col style={{ width:"55px" }} /><col style={{ width:"120px" }} />
                  <col style={{ width:"190px" }} /><col style={{ width:"260px" }} /><col style={{ width:"70px" }} />
                  <col style={{ width:"45px" }} /><col style={{ width:"65px" }} /><col style={{ width:"90px" }} />
